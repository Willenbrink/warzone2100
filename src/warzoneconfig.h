...
bool war_getFullscreen() asm ("getFullscreen");
...
bool war_GetVsync() asm ("getVsync");
void war_SetDisplayScale(unsigned int scale);
unsigned int war_GetDisplayScale();
void war_SetWidth(UDWORD width) asm ("war_set_width");
UDWORD war_GetWidth() asm ("war_get_width");
void war_SetScreen(int screen);
int war_GetScreen();
void war_SetHeight(UDWORD height) asm ("war_set_height");
UDWORD war_GetHeight() asm ("war_get_height");
