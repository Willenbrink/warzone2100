...
const char *getDroidOrderName(DROID_ORDER order)
{
	switch(order)
	{
		...
		case DORDER_HELPBUILD:
			return "DORDER_HELPBUILD";

		case DORDER_LINEBUILD:
			return "DORDER_LINEBUILD";

		case DORDER_DEMOLISH:
			return "DORDER_DEMOLISH";
		...
		case DORDER_FIRESUPPORT:
			return "DORDER_FIRESUPPORT";

		case DORDER_RETREAT:
			return "DORDER_RETREAT";

		case DORDER_UNUSED_2:
			return "DORDER_UNUSED_2";
		...
		case DORDER_EMBARK:
			return "DORDER_EMBARK";

		case DORDER_DISEMBARK:
			return "DORDER_DISEMBARK";

		case DORDER_ATTACKTARGET:
			return "DORDER_ATTACKTARGET";

		case DORDER_COMMANDERSUPPORT:
			return "DORDER_COMMANDERSUPPORT";

		case DORDER_BUILDMODULE:
			return "DORDER_BUILDMODULE";

		case DORDER_RECYCLE:
			return "DORDER_RECYCLE";

		case DORDER_TRANSPORTOUT:
			return "DORDER_TRANSPORTOUT";

		case DORDER_TRANSPORTIN:
			return "DORDER_TRANSPORTIN";

		case DORDER_TRANSPORTRETURN:
			return "DORDER_TRANSPORTRETURN";

		case DORDER_GUARD:
			return "DORDER_GUARD";

		case DORDER_DROIDREPAIR:
			return "DORDER_DROIDREPAIR";

		case DORDER_RESTORE:
			return "DORDER_RESTORE";

		case DORDER_SCOUT:
			return "DORDER_SCOUT";

		case DORDER_UNUSED_3:
			return "DORDER_UNUSED_3";

		case DORDER_UNUSED:
			return "DORDER_UNUSED";
		...
		case DORDER_RECOVER:
			return "DORDER_RECOVER";

		case DORDER_LEAVEMAP:
			return "DORDER_LEAVEMAP";

		case DORDER_RTR_SPECIFIED:
			return "DORDER_RTR_SPECIFIED";

		case DORDER_CIRCLE:
			return "DORDER_CIRCLE";
