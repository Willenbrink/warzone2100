...
{
	uint32_t powerRatio = (uint64_t)65536 * psVictim->getBuildPower() / psAttacker->getBuildPower();
	uint32_t pointsRatio = (uint64_t)65536 * psVictim->getBuildTime() / psAttacker->getBuildTime();
